...
class Executor {
  ...
  private:
    ...
    void _observer_appue(Worker&, Node*);
...
// Procedure: _observer_appue
inline void Executor::_observer_appue(Worker& worker, Node* node) {
